...
func TestGetCurrencyInfo(t *testing.T) {
	...
	tests := []struct {
		...
		{"Sterling", args{"GBP"}, Currency{Code: "GBP", SpotDays: 2, Name: "Pound Sterling", Character: "£", DPS: 2, QuoteDPS: 4, Type: Fiat, MajorUnit: "Pound", MinorUnit: "Pence", ISONumericCode: "826", KnownAs: "Pounds", MinorCharacter: "p", YearOfIntroduction: 800}, false},
